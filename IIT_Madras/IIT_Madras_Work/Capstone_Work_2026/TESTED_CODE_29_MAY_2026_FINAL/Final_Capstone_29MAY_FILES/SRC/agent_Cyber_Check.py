...
## Customer Support AI Agent and this Agent check for Cyber check and Mallicious attacks
...
def run_cyber_attack_check(query: str) :
    crew_cyber_check  = Crew(
        agents=[cyber_agent],
        tasks=[cyber_task],
        verbose=True,
    )
    ...
    with get_openai_callback() as cb:
            ...
            result = crew_cyber_check.kickoff(
                inputs={
                    "query": query
...
def execute_cyber_checks(query: str) :
        logging.info("========================")   
        logging.info(f"Cyber Attacks Check for  query: {query}")              
        ...
        output_cyber_checks = run_cyber_attack_check(query) 
        print("===============================")
        ...
        final_response = f"""
            ...
            Cyber Attacks Check  Result : {output_cyber_checks}
        ...
        print("Cyber Attacks Check  Result :", output_cyber_checks)
        print("\n")
        print("-" * 90)
        print("\n")
        logging.info("========================")   
        logging.info("Cyber Attack CHECK Testing Evaluation STARTED........")
        logging.info(f"Cyber Attack CHECK  Result : {output_cyber_checks}")
        logging.info("========================")   
        logging.info("Cyber Attack CHECK Testing Evaluation Completed........")
