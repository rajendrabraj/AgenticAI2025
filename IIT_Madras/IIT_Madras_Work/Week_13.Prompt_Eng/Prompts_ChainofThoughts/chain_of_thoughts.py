...
print("-----"*50)
print("Invoking REsponse #1 - math_word_problem")
...
print("-----"*50)
print("Invoking REsponse #2 - logical_deduction")
response_logical_prompt = llm.invoke(messages2)
print(response_logical_prompt.content)

print("-----"*50)

problem = problems["debugging_issue"]
problem_type = "code_debugging"
...
print("-----"*50)
print("Invoking REsponse #3 - Code Debugging")

response_debugging_prompt = llm.invoke(messages3)
print(response_debugging_prompt.content)
