...
##Different function to run the prompt testing for different prompts defined above

def run_prompt_testing(query):
        logging.info("========================")   
        logging.info(f"Executing prompt testing for query: {query}")        
        ...
        final_response = f"""
            ...
            BASIC OUTPUT Prompt Result : {output_basic}
            STRUCTURED OUTPUT Prompt Result : {output_structured}
            SAFE OUTPUT Prompt Result : {output_safe}"""


        print("BASIC OUTPUT Prompt Result :", output_basic)
        print("STRUCTURED OUTPUT Prompt Result :", output_structured)
        print("SAFE OUTPUT Prompt Result :", output_safe)
        print("-" * 90)
        logging.info("========================")   
        logging.info("Prompt Testing Evaluation STARTED........")
        ...
        logging.info("========================")   
        logging.info("Prompt Testing Evaluation Completed........")
...
def main() -> None:
    print("\n Inside Prompt Testing Main Function \n ")
    logging.info("Inside Prompt Testing Main Function")
...
## Run Experiments with different prompts for the resolution task to see how it affects the output and escalation decisions 
    ...
    print("Prompt OUTPUT:", result_prompt_testing)
    logging.info("========================")            
    logging.info(f"Prompt Testing Run #4 : {result_prompt_testing}")
    print("Prompt OUTPUT:", result_prompt_testing)
    logging.info("========================")           
