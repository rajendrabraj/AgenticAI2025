...
def generate_email_body(df):
    ...
    for category, group in df.groupby("category"):
        ...
        body += "\n"
        body += "#" * 80 + "\n"        
        body += f"#***** NEWS CATEGORY : {category.upper()} *****\n"
        #body += "=" * 80 + "\n\n"
        body += "#" * 80 + "\n\n"
...
def generate_report(df):
    ...
    df = df[["category","title","link","summary_short","combined"]]
    ...
    #     email_message_body += "\n"
    #     email_message_body += "=" * 70 + "\n"
    #     email_message_body += f"{category}\n"
    #     email_message_body += "=" * 70 + "\n\n"

    #     for _, row in group.iterrows():

    #         email_message_body += f"• {row['title']}\n"
    #         email_message_body += f"  {row['link']}\n\n"
