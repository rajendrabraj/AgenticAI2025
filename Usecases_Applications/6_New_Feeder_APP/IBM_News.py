...
logging.basicConfig(
    filename=os.path.join(parent_directory, "IBM_NewsFeederTask.log"),
...
RSS_FEEDS = [
    "https://newsroom.ibm.com/rss.php",
    "https://newsroom.ibm.com/rss.php?category=Artificial+intelligence",
    "https://research.ibm.com/blog/rss.xml",
    "https://www.ibm.com/blogs/think/feed/",
    "https://www.ibm.com/think/news/feed/",
    "https://newsroom.ibm.com/rss.php",
    "https://newsroom.ibm.com/rss.php?category=Artificial+intelligence",
    "https://research.ibm.com/blog/rss.xml",
    "https://www.ibm.com/blogs/think/feed/",
...
def send_email(body):   
    ...
    subject = f"IBM AI News Update - {today_date}"
